...
// パラメータの調整
    dark: {
        normal: {
            color: '#fff',
            background: { type: 'linear-gradient', start: '#888', end: '#555' },
...
enchant.ui.TimeLabel = enchant.Class.create(enchant.ui.MutableText, {
     ...
     * @param counttype
     */
    initialize: function(x, y, TIME_LIMIT) {
        enchant.ui.MutableText.call(this, 0, 0);
        switch (arguments.length) {
            case 3:
            case 2:
        ...
        this.addEventListener('enterframe', function() {
            ...
            this.text = this.label + (TIME_LIMIT - (this._time / enchant.Game.instance.fps)).toFixed(0);
        });
    },
    /**
     * 残り時間
